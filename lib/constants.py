...
HEALTH_POINT_POSITION_X_PLAYER = 45 * SCALE
HEALTH_POINT_POSITION_Y_PLAYER = 45 * SCALE
...
ENEMY_ATTACK_FILENAME = IMAGES_DIRECTORY + 'enemy_attack_new.png'
