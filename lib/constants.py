...
WIN_2_POSITION = [5150 * 2, PLATFORM_POSITION_Y]
WIN_3_POSITION = [5150 * 2, PLATFORM_POSITION_Y]
...
FIRST_SECOND_LEVEL_PLATFORM_POSITION = [8200, PLATFORM_POSITION_Y - PLATFORM_HEIGHT * 9]
SECOND_SECOND_LEVEL_PLATFORM_POSITION = [9000, PLATFORM_POSITION_Y - PLATFORM_HEIGHT * 6]
...
THIRTEEN_SECOND_LEVEL_PLATFORM_POSITION = [5000, PLATFORM_POSITION_Y]
...
FIRST_SECOND_LEVEL_PLATFORM_SIZE = [PLATFORM_WIDTH*0.4, PLATFORM_HEIGHT * 0.2]
SECOND_SECOND_LEVEL_PLATFORM_SIZE = [PLATFORM_WIDTH*0.4, PLATFORM_HEIGHT * 0.2]
...
THIRTEEN_SECOND_LEVEL_PLATFORM_SIZE = [300 * SCALE, PLATFORM_HEIGHT]
...
EIGHTEEN_SECOND_LEVEL_PLATFORM_SIZE = [0.5 * PLATFORM_WIDTH, 9 * PLATFORM_HEIGHT]
