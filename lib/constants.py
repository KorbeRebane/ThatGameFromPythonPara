...
FIRST_PLATFORM_POSITION = [400, PLATFORM_POSITION_Y]
SECOND_PLATFORM_POSITION = [80, PLATFORM_POSITION_Y + PLATFORM_HEIGHT]
...
FIRST_ENEMY_POSITION = [300, ENEMY_POSITION_Y]
...
G = 1500 * SCALE
DELTA_T = 1/FPS
WIN_POSITION = (1000, FLOOR_HEIGHT - PLAYER_HEIGHT)
