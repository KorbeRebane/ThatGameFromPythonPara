...
TWENTYFIVE_SECOND_LEVEL_PLATFORM_SIZE = [2 * PLATFORM_WIDTH, 20 * PLATFORM_HEIGHT]
...
TWELVTH_SECOND_LEVEL_ENEMY_POSITION = [9350, PLATFORM_POSITION_Y - PLATFORM_HEIGHT * 8 - ENEMY_HEIGHT]
