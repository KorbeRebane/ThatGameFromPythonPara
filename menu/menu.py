...
from lib.constants import SCALE, BUTTON_NEW_GAME_SIZE_WIDTH, BUTTON_NEW_GAME_SIZE_HEIGHT, BUTTON_EXIT_SIZE_HEIGHT, \
    BUTTON_EXIT_SIZE_WIDTH, BUTTON_EXIT_POSITION_X, BUTTON_EXIT_POSITION_Y, BUTTON_NEW_GAME_POSITION_X, \
    BUTTON_NEW_GAME_POSITION_Y
