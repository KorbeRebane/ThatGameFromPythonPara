...
test_level_platfroms_list = [Platform(FLOOR_POSITION, FLOOR_SIZE, FLOOR_FILENAME),
                          Platform(FIRST_ZERO_LEVEL_PLATFORM_POSITION, FIRST_ZERO_LEVEL_PLATFORM_SIZE, PLATFORM_FILENAME),
                          Platform(SECOND_ZERO_LEVEL_PLATFORM_POSITION, SECOND_ZERO_LEVEL_PLATFORM_SIZE, PLATFORM_FILENAME),
                          Platform(THIRD_ZERO_LEVEL_PLATFORM_POSITION, THIRD_ZERO_LEVEL_PLATFORM_SIZE, PLATFORM_FILENAME),
                          Platform(FOURTH_ZERO_LEVEL_PLATFORM_POSITION, FOURTH_ZERO_LEVEL_PLATFORM_SIZE, PLATFORM_FILENAME),
                          WinPlatform(WIN_POSITION, WIN_SIZE, PLATFORM_FILENAME)
                          ]
test_level_enemy_list = [Enemy(copy(FIRST_ENEMY_POSITION)),Enemy(copy(SECOND_ENEMY_POSITION))]
